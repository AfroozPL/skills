          ...
          >
            <div>
              <div className="flex items-center justify-between gap-2">
                <h3 className="text-lg font-bold text-slate-800 ltr">
                  {term.term}
                </h3>
                <SpeakButton text={term.term} label="تلفظ" />
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {term.examples.map((ex, j) => (
                  <li
                    key={j}
                    className="ltr flex items-center gap-2 rounded-lg bg-slate-50 px-3 py-2 text-sm leading-7 text-slate-700"
                  >
                    <span className="text-slate-400 tabular">{j + 1}.</span>
                    <span className="flex-1">{ex}</span>
                    <SpeakButton text={ex} variant="icon" />
                  </li>
                ))}
              </ul>
            </div>
